...
// return the lsn to the caller. The caller must release
// it back to the OS with lsn.Close() before using the port.
func getAvailPort() (port int, lsn net.Listener) {
