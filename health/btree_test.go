...
func Test201BtreeInsertDisplay(t *testing.T) {
	...
	expect := `[{"serverId":"abc","host":"","port":0,"leaseExpires":"0001-01-01T00:00:00Z","rank":0,"pid":0},{"serverId":"xyz","host":"","port":0,"leaseExpires":"0001-01-01T00:00:00Z","rank":0,"pid":0}]`
	if s != expect {
